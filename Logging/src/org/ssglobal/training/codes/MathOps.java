...
public class MathOps {
	...
	public int[] displayArray(int[] arrData) {
		logger.info("start of method div() with parameters arrData=%s".formatted(Arrays.toString(arrData)));
		...
		logger.info("end of method div() with parameters arrData=%s".formatted(Arrays.toString(arrData)));
		return arrData;
	}
}
